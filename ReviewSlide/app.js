...
let revName = document.querySelector("#author");
let revJob = document.querySelector("#job");
...
right.addEventListener("click", () => {
  if (currentIndex < reviews.length-1) {
    ...
    revName.textContent = reviews[currentIndex].name;
    revJob.textContent = reviews[currentIndex].job;
